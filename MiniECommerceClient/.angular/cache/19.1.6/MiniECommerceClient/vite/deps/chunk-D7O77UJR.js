...
// node_modules/flexi-button/fesm2022/flexi-button.mjs
var _c0 = ["*"];
function FlexiButtonComponent_Conditional_1_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function FlexiButtonComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelement(0, "span", 1);
    ɵɵtemplate(1, FlexiButtonComponent_Conditional_1_Conditional_1_Template, 2, 1, "span", 2);
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
    ɵɵadvance();
    ɵɵconditional(ctx_r0.loadingText() ? 1 : -1);
  }
}
function FlexiButtonComponent_Conditional_2_Conditional_0_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "span", 2);
    ɵɵtext(1);
    ɵɵelementEnd();
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵtextInterpolate(ctx_r0.btnText());
    ɵɵadvance(2);
    ɵɵtextInterpolate1(" ", ctx_r0.btnIcon(), " ");
  }
}
function FlexiButtonComponent_Conditional_2_Conditional_0_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function FlexiButtonComponent_Conditional_2_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, FlexiButtonComponent_Conditional_2_Conditional_0_Conditional_0_Template, 4, 2)(1, FlexiButtonComponent_Conditional_2_Conditional_0_Conditional_1_Template, 4, 2);
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
    ɵɵconditional(ctx_r0.firstText() ? 0 : 1);
  }
}
function FlexiButtonComponent_Conditional_2_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "span", 3);
    ɵɵtext(1);
    ɵɵelementEnd();
...
function FlexiButtonComponent_Conditional_2_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "span", 2);
    ɵɵtext(1);
    ɵɵelementEnd();
...
function FlexiButtonComponent_Conditional_2_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵprojection(0);
  }
}
function FlexiButtonComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, FlexiButtonComponent_Conditional_2_Conditional_0_Template, 2, 1)(1, FlexiButtonComponent_Conditional_2_Conditional_1_Template, 2, 1, "span", 3)(2, FlexiButtonComponent_Conditional_2_Conditional_2_Template, 2, 1, "span", 2)(3, FlexiButtonComponent_Conditional_2_Conditional_3_Template, 1, 0);
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
    ɵɵconditional(ctx_r0.btnText() && ctx_r0.btnIcon() ? 0 : ctx_r0.btnIcon() ? 1 : ctx_r0.btnText() !== void 0 ? 2 : 3);
  }
}
var FlexiButtonComponent = class _FlexiButtonComponent {
  constructor() {
    this.btnIcon = input(void 0);
    this.btnColor = input("light");
    this.btnSize = input("small");
    this.btnText = input(void 0);
    this.btnType = input("button");
    this.btnDisabled = input(false);
    this.firstText = input(false);
    this.btnRounded = input(false);
    this.loading = input(false);
    this.btnFloat = input(false);
    this.loadingText = input(void 0);
    this.btnWidth = input(void 0);
  }
  static {
    this.ɵfac = function FlexiButtonComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _FlexiButtonComponent)();
    };
  }
  static {
    this.ɵcmp = ɵɵdefineComponent({
      type: _FlexiButtonComponent,
      selectors: [["flexi-button"]],
      hostVars: 1,
      hostBindings: function FlexiButtonComponent_HostBindings(rf, ctx) {
        if (rf & 2) {
          ɵɵattribute("data-instance-id", ctx.instanceId);
        }
      },
      inputs: {
        btnIcon: [1, "btnIcon"],
        ...
        btnText: [1, "btnText"],
        btnType: [1, "btnType"],
        btnDisabled: [1, "btnDisabled"],
        firstText: [1, "firstText"],
        btnRounded: [1, "btnRounded"],
        loading: [1, "loading"],
        btnFloat: [1, "btnFloat"],
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(FlexiButtonComponent, [{
    type: Component,
    args: [{
...
//# sourceMappingURL=chunk-D7O77UJR.js.map
